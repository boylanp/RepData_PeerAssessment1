...
plot(sm[, 1], sm[, 2], type = 'l', xlab = "5-min Interval", ylab = "Average Number of Steps", main = "Average Number of Steps Taken Each Day")
```
...
hist(sm2[, 2], main="Histogram of total steps after replacing missing data", xlab = "Total Number of Steps")
